...
public class Netter {
    ...
    public Try<JSONObject> get(String url, Map<String, String> params, Map<String, String> headerMap) {
    ...
    public Try<JSONObject> post(String url,
    ...
    @SneakyThrows
    public Try<JSONObject> execute(Request request) {
        log.info("返回的请求头：" + request);
        ...
        try (Response response = client.newCall(request).execute()) {
            ...
            return new Success<>((JSONObject) JSONObject.toJSON(stringBody));
    ...
    @SneakyThrows
    public Try<JSONObject> execute(RequestContent requestContent) {
