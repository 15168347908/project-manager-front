...
public class RegexUtil {
     ...
     * 正则：整数
     */
    public static final String REGEX_INTEGER = "^-?0*[1-9]\\d*$";
    /**
     * 正则：带正好或负号的整数
     */
    public static final String REGEX_INTERGER_WITH_SYMBOL = "^[-\\+]?0*\\d+";
    /**
     * 正则：非负整数(正整数 + 0)
     */
     ...
     * 正则：逗号分隔字符串
     */
    public static final String REGEX_SPLIT = "^[\\w|\u4E00-\u9FA5]+(,[\\w|\u4E00-\u9FA5]+)*";

    /**
     * 正则：专利号，2003 年之后
     */
    public static final String PATANT_CODE_AFTER_2003 = "^ZL[12]\\d{3}[12389]\\d{7}\\.[\\dX]$";

    /**
     * 正则：专利号，2003 年之前
     */
    public static final String PATANT_CODE_BEFORE_2003 = "^ZL\\d{2}[12389]\\d{5}.[\\dX]$";

    /**
     * 正则：专利号，2003 年之后，不含 ZL
     */
    public static final String PATANT_CODE_AFTER_2003_NOT_ZL = "^[12]\\d{3}[12389]\\d{7}\\.[\\dX]$";

    /**
     * 正则：专利号，2003 年之前，不含 ZL
     */
    public static final String PATANT_CODE_BEFORE_2003_NOT_ZL = "^\\d{2}[12389]\\d{5}.[\\dX]$";
    ...
    /**
     * 校验是否是逗号分隔字符串，只能由下划线，数字，字母组成
     *
     * @param input 待验证文本
     * @return 是否验证成功
     */
    public static boolean isSplit(CharSequence input) {
        return isMatch(REGEX_SPLIT, input);
    }
     ...
     * @return @{@code true}: 匹配<br>{@code false}:不匹配
     */
    public static boolean isUnifiedSocialCreditCode(String license) {
        if (license.length() != 18) {
            return false;
        }
        if (!license.matches(UNIFIED_SOCIAL_CREDIT_CODE)) {
            return false;
        }
        //验证校验位
